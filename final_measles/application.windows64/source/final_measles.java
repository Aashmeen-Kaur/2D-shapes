...
public class final_measles extends PApplet {

//Global Variables
float faceSquareX, faceSquareY, faceSquareSide;
float faceX, faceY, faceDiameter;
float leftEyeX, leftEyeY, rightEyeX, rightEyeY, eyeDiameter, eye2Diameter;
float noseX, noseY, noseWidth, noseHeight, noseX3, noseY3;
float mouthX1, mouthY1, mouthX2, mouthY2, mouthThick;
int red = 0xffF01313, white = 0xffFFFFFF, blue = 0xff63B5EA, black = 0xff000000, darkRed = 0xffc40000, green = 0xff0A6714, purple = 0xff7d22bf;
...
public void populatingVariables() {
  ...
  float noseWidthRatio = 250.0f/300.0f; 
  float noseHeightRatio = 250.0f/300.0f;
  noseX = width*10/28;
  noseY = height*4/10.5f;
...
public void button3text() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "final_measles" };
    if (passedArgs != null) {
